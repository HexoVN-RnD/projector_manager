...
class ManageProjector extends StatefulWidget {
  Projector projector;
  ManageProjector({
    required this.projector,
  });
  @override
  _ManageProjectorState createState() => _ManageProjectorState();
}

class _ManageProjectorState extends State<ManageProjector> {
  @override
